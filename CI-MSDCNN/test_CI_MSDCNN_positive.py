...
from train_CI_MSDCNN_positive import MultiScaleDilatedCNN   # 把训练脚本文件名改成这个更稳
...
if __name__ == '__main__':
    ...
    # 测试HDF5文件所在路径，并进行读取
    TestFile = "../data/qtofposspikeplasma97.h5"
    ...
    # 2. 加载权重
    checkpoint = torch.load("../Result/models/CI-MSDCNN_positive.pth", map_location=device)
    ...
    # 4. 保存预测结果到 Excel
    save_path = '../Result/qtofposspikeplasma97.xlsx'
    wb = Workbook()
    ws = wb.active
